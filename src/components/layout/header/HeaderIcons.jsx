...
const HeaderIcons = ({isCartOpen, isSearchOpen, setActivePanel}) => {
  return (
    <>
      <IconButton 
        label={"open search"}
        ...
        onClick={() => {
          setActivePanel(isSearchOpen ? null : "search")
        }}
      >
        ...
        <IconButton
          ...
          state={isCartOpen}
          onClick={() => {
            setActivePanel(isCartOpen ? null : "cart")
          }}
        >
        ...
        <IconButton label="open login form">
